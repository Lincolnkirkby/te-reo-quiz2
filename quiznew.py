...
def generate_question(english,right_answer,option_1,option_2): #define a function to generate a question
  global score
  print("which one is a possible translation for",english,"in maori")
...
print("starting quiz",num_of_questions,"questions")
...
if score == num_of_questions: #print the score at the end of the quiz
  print("wow you are truly amazing, 100%, you got",num_of_questions,"/",num_of_questions,)
