...
option_1 = ['katariri','kirokangi','kongai','ka','ragnero','kara','kanwhmanwh','karaka','whero','nuki','hiiki','ooata','pamoo','pamakine','tuungano','teenai','tuakanaa','kauaenguaa','kuaakana','keinaa','kainguahinii','tapuuna','kupunapuna tatipe','pukuunga ngohine','ngepo','nutenuti','pepipa','nguukui','pau','haaoho','heeihai','reepetai','pinae','penipeniraakau','pukapukapuka','whangea','tamaii','raauine','pukaia','ngowhohipo','koomuia','teekau','weni','kaapata','nohoawhaa','paaparangua','koowhiuwhiu','whanau','kaaua','peipaka']
